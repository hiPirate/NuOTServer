...
#ifdef DEBUG_LOG
	SPDLOG_DEBUG("[NuOTServer] SPDLOG LOG DEBUG ENABLED");
...
void mainLoader(int, char*[], ServiceManager* services) {
	...
	SPDLOG_INFO("Developed By: {}", STATUS_SERVER_DEVELOPERS);
	SPDLOG_INFO("Check out NuOTServer's GitHub Repository: "
		"https://github.com/PirateCrypto/NuOTServer");
