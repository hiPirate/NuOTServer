...
static constexpr auto STATUS_SERVER_NAME = "NuOTServer";
static constexpr auto STATUS_SERVER_VERSION = "0.1a";
static constexpr auto STATUS_SERVER_DEVELOPERS = "Aeluu";
